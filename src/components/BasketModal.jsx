      ...
      <>
         ...
         {isOpen && (
            <div className="modal modal-open">
               <div className="modal-box max-w-md text-black">
                  ...
                  {cartItems.length === 0 ? (
                     ...
                     cartItems.map(item => (
                        <li key={item.id} className="text-black flex justify-between items-center pb-4 mb-4 border-b border-gray-400">
                           ...
                           <div className="ml-8 flex-8 w-48 text-left">
                              <div className="font-medium mb-1 text-black">{item.name}</div>
                              <div className="flex items-center space-x-2 text-black">
                                 ...
                                 <select
                                    ...
                                    className="select select-bordered select-xs w-[3.5rem] px-2 text-black"
                                 >
